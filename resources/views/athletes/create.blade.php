...
<div class="container mx-auto px-4 py-8 max-w-4xl">   
    ...
    <div class="bg-white rounded-xl shadow-lg overflow-hidden">
        ...
        <form method="POST" action="/athletes" enctype="multipart/form-data" class="p-6">
            @csrf
                ...
                <div class="mb-4">
                    ...
                    <div class="flex space-x-4">
                        <div class="flex items-center">
                            <input type="radio" name="jenis_kelamin" id="putra" value="Putra" {{ old('jenis_kelamin') == 'Putra' ? 'checked' : '' }} 
                                   class="w-4 h-4 text-blue-600 border-gray-300 focus:ring-blue-500">
                            <label for="putra" class="ml-2 text-gray-700">Putra</label>
                        </div>
                        <div class="flex items-center">
                            <input type="radio" name="jenis_kelamin" id="putri" value="Putri" {{ old('jenis_kelamin') == 'Putri' ? 'checked' : '' }} 
                                   class="w-4 h-4 text-blue-600 border-gray-300 focus:ring-blue-500">
            ...
            <div class="mb-4">
                ...
                <div class="mb-4 md:col-span-2">
                    ...
                    <input type="hidden" name="kelompok_umur" id="kelompok_umur_hidden" value="{{ old('kelompok_umur') }}">
                    @error('kelompok_umur')
                        <p class="text-red-500 text-xs italic mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mb-4 md:col-span-2">
                    ...
                    <div class="flex flex-wrap gap-4">
                        <div class="flex items-center">
                            <input type="radio" name="jenis_pertandingan" id="Kyourigi" value="Kyourigi" {{ old('jenis_pertandingan') == 'Kyorugi' ? 'checked' : '' }} 
                                   class="w-4 h-4 text-blue-600 border-gray-300 focus:ring-blue-500">
                            <label for="Kyourigi" class="ml-2 text-gray-700">Kyourigi</label>
                        </div>
                        <div class="flex items-center">
                            <input type="radio" name="jenis_pertandingan" id="Poomsae" value="Poomsae" {{ old('jenis_pertandingan') == 'Poomsae' ? 'checked' : '' }} 
                                   class="w-4 h-4 text-blue-600 border-gray-300 focus:ring-blue-500">
                            <label for="Poomsae" class="ml-2 text-gray-700">Poomsae</label>
                        </div>
                        <div class="flex items-center">
                            <input type="radio" name="jenis_pertandingan" id="Poomsae Freestyle" value="Poomsae Freestyle" {{ old('jenis_pertandingan') == 'Poomase Freestyle' ? 'checked' : '' }} 
                                   class="w-4 h-4 text-blue-600 border-gray-300 focus:ring-blue-500">
...
'Poomsae Freestyle': {
    ...
    function updateKelompokUmur() {
        ...
        updateKelasOptions(); // refresh kelas juga
    }
    ...
    function updateTingkatOptions(kelompokUmur) {
        ...
        options.forEach(option => {
            ...
            if ("{{ old('tingkat_pertandingan') }}" === option) {
                opt.selected = true;
            }
    ...
    kelasList = [];
        ...
        kelasList.forEach(kelas => {
            ...
            if ("{{ old('kelas_pertandingan') }}" === kelas) {
                opt.selected = true;
            }
    ...
    document.querySelectorAll('input[name="jenis_pertandingan"], input[name="jenis_kelamin"]').forEach(input => {
        input.addEventListener('change', updateKelasOptions);
    });

    // Inisialisasi jika ada old data
    if (tanggalLahirInput.value) updateKelompokUmur();
});
</script>
