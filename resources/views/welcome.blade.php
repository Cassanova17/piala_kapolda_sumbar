        ...
        <div class="container mx-auto px-4">
            ...
            <div class="flex flex-col lg:flex-row items-center gap-12">
                ...
                <div class="lg:w-1/2 space-y-6">
                    ...
                    <a href="/proposals/Proposal_Kapolda_Sumbar_National_2025.pdf" target="_blank" class="inline-block mt-6 btn-primary text-white font-semibold px-8 py-3 rounded-md">Tentang Kejuaraan</a>
                ...
                <div class="bg-white rounded-xl shadow-md overflow-hidden">
                    <div class="grid grid-cols-1 md:grid-cols-2 divide-y md:divide-y-0 md:divide-x divide-gray-200">
                        ...
                        <div class="p-8">
                            <div class="flex items-center gap-4 mb-6">
                                <div class="bg-blue-100 text-blue-800 p-3 rounded-lg">
                                    <span class="text-2xl font-bold block">19</span>
                                    <span class="text-sm">Juni</span>
                                </div>
                                <h3 class="text-xl font-bold text-gray-800">Technical Meeting dan Keabsahan</h3>
                            </div>
                        ...
                        <div class="p-8">
                            <div class="flex items-center gap-4 mb-6">
                                <div class="bg-blue-100 text-blue-800 p-3 rounded-lg">
                                    <span class="text-2xl font-bold block">20</span>
                                    <span class="text-sm">Juni</span>
                                </div>
                                <h3 class="text-xl font-bold text-gray-800">Pembukaan dan Pertandingan Hari Pertama</h3>
                            </div>
                            <ul class="space-y-4 text-gray-600">
                                <li class="flex items-start gap-3">
                                    <svg class="w-5 h-5 text-red-600 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 divide-y md:divide-y-0 md:divide-x divide-gray-200 bg-gray-50">
                        ...
                        <div class="p-8">
                            <div class="flex items-center gap-4 mb-6">
                                <div class="bg-blue-100 text-blue-800 p-3 rounded-lg">
                                    <span class="text-2xl font-bold block">21</span>
                                    <span class="text-sm">Juni</span>
                                </div>
                                <h3 class="text-xl font-bold text-gray-800">Hari Pertandingan</h3>
                            </div>
                            <ul class="space-y-4 text-gray-600">
                                <li class="flex items-start gap-3">
                                    <svg class="w-5 h-5 text-red-600 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="p-8">
                            <div class="flex items-center gap-4 mb-6">
                                <div class="bg-blue-100 text-blue-800 p-3 rounded-lg">
                                    <span class="text-2xl font-bold block">22</span>
                                    <span class="text-sm">Juni</span>
                                </div>
                                <h3 class="text-xl font-bold text-gray-800">Hari Pertandingan & Penutupan</h3>
                            </div>
                            <ul class="space-y-4 text-gray-600">
                                <li class="flex items-start gap-3">
                                    <svg class="w-5 h-5 text-red-600 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="container mx-auto px-4">
                    ...
                    <div class="space-y-4">
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-white/80">+62 8137 4497 222</p>
                            </div>
                        </div>
                        <div class="flex items-start gap-4">
                            <div class="bg-white/20 p-2 rounded-full">
            ...
            <div class="mt-12 text-center">
                ...
                <div class="flex justify-center space-x-4">
                    <a href="https://www.facebook.com/eka.ekasabam" class="bg-white/10 p-3 rounded-full hover:bg-white/20 transition duration-300">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                            <path d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z"></path>
                        </svg>
                    </a>
                    <a href="https://www.instagram.com/kepin_d_ydhstra?igsh=cHJsc2Vwcjl5MzZq" class="bg-white/10 p-3 rounded-full hover:bg-white/20 transition duration-300">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="https://wa.me/6281374497222" target="_blank" class="bg-white/10 p-3 rounded-full hover:bg-white/20 transition duration-300">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
